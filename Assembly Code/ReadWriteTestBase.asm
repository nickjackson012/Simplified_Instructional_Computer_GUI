. Duplicate of ReadWrite.asm (pg. 45)
. Copied to protect the state of ReadWrite.asm
. Used as a clean base for the code used to test the SIC Assembler and SIC Simulator
.LABEL	OPCODE	OPERAND		REMARKS
COPY	START	1000			COPY FILE FROM INPUT TO OUTPUT
FIRST	STLX		RETADR			SAVE RETURN ADDRESS
